...
class TestEdgeCases:
    ...
    def test_empty_ecosystem(self, mock_transformer):
        ...
        papers_data = {'TAM1': {
            'title': 'TAM', 'abstract': 'TAM paper',
            'keywords': 'TAM', 'citations': 100, 'year': 1989
        }}
    ...
    def test_papers_without_constructs(self, mock_transformer, sample_citation_data):
        ...
        construct_cols = ['has_usefulness', 'has_ease_of_use', 'has_acceptance', 'has_intention', 'has_attitude']
    ...
    def test_multiword_theory_name(self, mock_transformer, sample_citation_data):
        ...
        assert features.loc[0, 'acronym_in_title'] == 1 or features.loc[0, 'acronym_in_abstract'] == 1
